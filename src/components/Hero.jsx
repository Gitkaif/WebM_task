      ...
      <section className="relative overflow-hidden bg-white mt-6 min-h-[600px]">
        <div className="w-full px-4 sm:px-6 md:px-8 py-8 h-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10 items-center h-full">
            ...
            {/* Left block (Text) */}
            <div className="order-1 lg:order-1 mx-auto lg:ml-16 xl:ml-24 text-center lg:text-left space-y-4">
              <p className="text-slate-900 font-extrabold tracking-tighter leading-none text-3xl sm:text-5xl md:text-6xl">
                YEP, IT'S
              </p>
              <h1 className="text-slate-900 font-extrabold tracking-tighter leading-none text-4xl sm:text-7xl md:text-8xl">
                ALL IN ONE APP
              </h1>
              <p className="text-slate-700 text-lg sm:text-xl md:text-2xl tracking-tight max-w-2xl mx-auto lg:mx-0">
                Invest in thousands of stocks, crypto, ETFs... all in one
            ...
            {/* Right block (Image) */}
            <div className="order-2 lg:order-2 flex justify-center mt-6 lg:mt-0">
              <img
                src={heroo}
                alt="Hero"
          ...
          <div className="mt-6 text-center lg:text-right">
            <p className="text-slate-600 text-sm sm:text-base underline font-bold mr-0 lg:mr-10">
      ...
      <section className="relative w-full bg-[#0b0f12] text-white py-16">
        <div className="w-full px-6 md:px-12 lg:px-20">
          <div className="w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 items-center gap-12 lg:gap-20">
            ...
            {/* Right image */}
            <div className="order-2 lg:order-2 relative flex justify-center mt-6 lg:mt-0">
